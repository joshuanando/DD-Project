...
--select T.ID_TOOLS,T.NAMA,TC.NAMA as Kategori,T.STATUS FROM TOOLS T,TOOLS_CATEGORY TC WHERE T.ID_KATEGORI=TC.ID_KATEGORI;
--SELECT * FROM TOOLS;
CREATE MATERIALIZED VIEW LOCAL_TOOLS as select T.ID_TOOLS,T.NAMA,TC.NAMA as Kategori,T.STATUS FROM TOOLS T,TOOLS_CATEGORY TC WHERE T.ID_KATEGORI=TC.ID_KATEGORI;
